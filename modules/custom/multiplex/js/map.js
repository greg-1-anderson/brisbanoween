			...
			for (x; x < locations.length; x++) {
				...
				if (this.i_marker_cache[x] == null) {
					...
					this.i_marker_cache[x].marker = new google.maps.Marker({
						...
						map: this.i_map,
						icon: legendMap[locations[x].legendId] ? this.i_config.iconBaseURL + legendMap[locations[x].legendId].icon : null
					});
					...
					this.i_marker_cache[x].marker.setIcon(legendMap[locations[x].legendId] ? this.i_config.iconBaseURL + legendMap[locations[x].legendId].icon : null);
